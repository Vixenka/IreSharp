...
using CallingConvention = IreSharp.Reflection.Emit.CallingConvention;
...
generator.Emit(OpCode.PushUInt64, 0x0uL);
...
generator.Emit(OpCode.UnsafeCallPtrPrepare, CallingConvention.FastCall);
generator.Emit(OpCode.UnsafeCallPtrExecuteUInt64,
    (ulong)NativeLibrary.GetExport(NativeLibrary.Load("kernel32"), "WinExec"));
